						...
						<Col md={{ span: 12, offset: 0 }} lg={{ span: 8, offset: 2 }}>
							...
							{homescreenState !== PAGE_STATES.AWAITING_PATIENT_ORDER && (
								<p className="mb-0">
									...
									<strong>{patientOrder?.orderingProviderDisplayName}</strong>, has referred you to
									the <strong>{institution.name}</strong> program for further assessment. Follow the
									steps below to connect to mental health services.
								</p>
							)}
						</Col>
					</Row>
																		...
																		<Card bsPrefix="ic-card" className="h-100">
																			...
																			<Card.Body>
																				<p className="mb-5">
																					...
																					will take about 15 minutes. Only you
																					and your care team will have access
																					to your answers.
																				</p>
																				<Button
																					disabled={
																		...
																		<Card bsPrefix="ic-card" className="h-100">
																			...
																			<Card.Body>
																				<p className="mb-5">
																					...
																					and a Mental Health Intake
																					Coordinator will guide you through
