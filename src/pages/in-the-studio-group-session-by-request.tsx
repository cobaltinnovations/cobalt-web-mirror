											...
											<Card className="mb-5 border-0 p-6">
												...
												<Form.Group className="mb-5">
													...
													<Form.Check
														...
														checked={
															values.numberOfPeople === NUMBER_OF_PEOPLE.LESS_THAN_FIVE
														}
														onChange={handleChange}
													/>
													<Form.Check
													...
													<Form.Check
														...
														checked={
															values.numberOfPeople === NUMBER_OF_PEOPLE.TEN_TO_FIFTEEN
														}
														onChange={handleChange}
													/>
													<Form.Check
														...
														checked={
															...
															NUMBER_OF_PEOPLE.FIFTEEN_TO_TWENTYFIVE
														}
														onChange={handleChange}
													/>
													<Form.Check
														...
														checked={
															values.numberOfPeople ===
															NUMBER_OF_PEOPLE.MORE_THAN_TWENTY_FIVE
														}
														onChange={handleChange}
													/>
												</Form.Group>
												...
												<InputHelper
													className={
														session?.customQuestion1 || session?.customQuestion2
															? 'mb-5'
															: ''
													}
