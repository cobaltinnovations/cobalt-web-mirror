...
import IntegratedCareScreeningPage from './ic-screening';
import IntegratedCarePatientInfoPage from './patient-info';

const IntegratedCareLandingPage = () => {
	const { account } = useAccount();

	const isPatient = account?.roleId === 'PATIENT';

	return (
		<SentryRoutes>
			<Route element={<Outlet />}>
				<Route index element={isPatient ? <PatientLanding /> : <ProviderLanding />} />

				<Route path="patient-info" element={<IntegratedCarePatientInfoPage />} />
