...
const PathwaysIcon = ({
	...
	const iconMap: Record<FeatureId, JSX.Element> = {
		...
		[FeatureId.MEDICATION_PRESCRIBER]: (
			<SvgIcon kit="fas" icon="prescription-bottle-medical" className={className} {...svgProps} />
		),
		[FeatureId.GROUP_SESSIONS]: <SvgIcon kit="fas" icon="family" className={className} {...svgProps} />,
		...
		[FeatureId.SELF_HELP_RESOURCES]: <SvgIcon kit="fas" icon="book-open" className={className} {...svgProps} />,
