...
| MHIC order shelf/detail            | `src/routes/ic/mhic/patient-order-shelf.tsx`, `src/routes/ic/mhic/order-layout.tsx`                                                         | `getPatientOrder`, `patchPatientOrder`, `getClinicalReport`, `setEncounterCsn`, `overrideSchedulingEpicDepartment`                            |
