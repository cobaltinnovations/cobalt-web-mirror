...
function configureReactApp(indexFilePath) {
	const fe_envVars = [
		...
		'COBALT_WEB_PIC_CLIENT_ID',
		'COBALT_WEB_PIC_PATIENT_SCOPES',
		'COBALT_WEB_PIC_OP_SERVER',
		'COBALT_WEB_PIC_REDIRECT_URL',
		'COBALT_WEB_PIC_RESPONSE_TYPE',
